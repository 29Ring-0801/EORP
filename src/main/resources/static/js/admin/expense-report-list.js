$(function (){
            ...
            if (item.nextDealEm == null) {
                if (item.status < 0) {
                    html += ' <tr>'
                        ...
                        + '    <td>'
                        + '        <div class="btn-group">'
                        + '            <a class="btn btn-xs btn-default" href="/expenseReport/goExpenseReportEdit?edit=true&expenseId=' + (item.expenseId) + '" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>'
                        + '            <a class="btn btn-xs btn-default" href="/expenseReport/goExpenseReport?expenseId=' + (item.expenseId) + '" title="查看" data-toggle="tooltip"><i class="mdi mdi-eye"></i></a>'
    ...
    function departmentStatus(status){
        ...
        return '<td><font class="text-warning">处理中</font></td>';
    }
