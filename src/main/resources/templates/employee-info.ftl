                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="employee-name" name="employee-name" value="" disabled/>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="login-name">登录账号</label>
                                        <input type="text" class="form-control" id="login-name" name="login-name" value="" disabled/>
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="clearfix">
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input id="status-off" type="radio" name="status" value="0" disabled><span>离职</span>
                                            </label>
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input id="status-on" type="radio" name="status" value="1" checked disabled><span>在职</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
