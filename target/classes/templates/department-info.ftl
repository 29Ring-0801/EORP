              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="dep-name" name="dep-name" value="" placeholder="请输入部门名称" disabled/>
                  </div>
                  <div class="form-group col-md-12">
                    <label for="dep-address">部门地址</label>
                    <input type="text" class="form-control" id="dep-address" name="dep-address" value="" placeholder="请输入部门地址" disabled/>
                  </div>
                  <div class="form-group col-md-12">
...
<script type="text/javascript" src="/static/js/admin/department-operation.js"></script>
</body>
</html>